...
![k8s](/images/tutorials/k8s/minikube/3.jpg)
...
![k8s](/images/tutorials/k8s/minikube/1.png)
...
<Callout type="info" emoji="">
Agar siz minikubeni serveringizga o'rnatgan bo'lsangiz minikube dashboardga tashqaridan kira olmaysiz yani faqat server o'zidan kirsa bo'ladi. minikube dashboardni tashqariga ochish uchun quyidagi `kubectl proxy` dan foydalaning
```bash
...
```
Hoizir sizda serveringiz IP addresida `8001` portda minikube dashboard ochiladi.
</Callout>

![k8s](/images/tutorials/k8s/minikube/2.jpg)
...
LoadBalancer o'rnatilishiga kirish uchun `minikube tunnel` buyrug'idan foydalaning. Bu yerda deployment misoli:
